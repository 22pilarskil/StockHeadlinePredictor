import torch
from transformers import BertTokenizer, AdamW, BertForSequenceClassification, AutoTokenizer
...
def train_epoch(model, data_loader, loss_function, optimizer, device, epoch):
    ...
    for batch_num, batch in enumerate(data_loader):
        ...
        logits = model(input_ids=input_ids, financial_data=financial_data)
...
if __name__ == "__main__":
    ...
    model = BaselineModel(modelname='yiyanghkust/finbert-tone')
